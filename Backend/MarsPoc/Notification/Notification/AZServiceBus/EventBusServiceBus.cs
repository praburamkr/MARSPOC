...
{
    public class AZServiceBus : IEventBus
    {
        private readonly IServiceBusPersisterConnection _serviceBusPersisterConnection;
        private readonly ILogger<AZServiceBus> _logger;
        private readonly IEventBusSubscriptionsManager _subsManager;
        private readonly SubscriptionClient _subscriptionClient;
        private readonly ILifetimeScope _autofac;
        private readonly string AUTOFAC_SCOPE_NAME = "MARS_event_bus";
        ...
        private void RemoveDefaultRule()
        {
            ...
            catch (MessagingEntityNotFoundException rr)
            {
               // _logger.LogWarning("The messaging entity {DefaultRuleName} Could not be found.{0}, {1}", RuleDescription.DefaultRuleName, rr.Message);
            }
        }
    }
}
